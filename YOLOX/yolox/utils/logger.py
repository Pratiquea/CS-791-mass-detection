...
class WandbLoggerCvAM(object):
    ...
    def _log_validation_set(self, val_dataset):
        ...
        if self.val_artifact is None:
            ...
            for i in range(self.num_log_images):
                data_point = val_dataset[i][0]
                # print("datapoint = {}".format(data_point))
                img = data_point[0]
                id = data_point[3]
                # print("img len = {}".format(len(img)))
                # print("img 1 shape = {}".format(data_point[0].shape))
                # print("img 2 shape = {}".format(data_point[1].shape))
                # print("img 3 shape = {}".format(data_point[2].shape))
                # print("img 4 shape = {}".format(data_point[3].shape))
                # if isinstance(img, tuple):
                #     img = img[0]
                #     print("img 1 len = {}".format(len(img)))
