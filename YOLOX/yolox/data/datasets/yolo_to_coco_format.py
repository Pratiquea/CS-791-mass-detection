...
# print("getcatids = {}".format(coco.getCatIds()))

# getCatIds get all the ids in the dataset since no arguments are provided. Output of coco.getCatIds is list of ids as follows: [1, 2, 3, 4, 5,....]
# loadCats load a list of dicts containing keys such as supercategory, name and id, eg [{'supercategory': 'person', 'id': 1, 'name': 'person'}, {'supercategory': 'vehicle', 'id': 2, 'name': 'bicycle'}, {'supercategory': 'vehicle', 'id': 7, 'name': 'train'}]
cats = coco.loadCats(coco.getCatIds())
#  list of names of all the unique categories in the dataset
